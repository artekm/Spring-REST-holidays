...
public class HolidaysRestTest {
    ...
    public void getAnnual_returnsHolidays_forGivenYear() throws Exception {
        ...
        List<Holiday> holi = Collections.singletonList(new Holiday(LocalDate.of(2019, 1, 1), "abcdef"));
    ...
    public void getPeriod_returnsHolidays_forGivenPeriod() throws Exception {
        ...
        List<Holiday> holi = Collections.singletonList(new Holiday(LocalDate.of(2019, 1, 1), "qwerty"));
